<div>
    @if (empty($feed))
        <button disabled class="btn btn-outline-secondary btn-sm mb-3">Create item</button>
        <small class="form-control-plaintext">Save the feed before creating an item.</small>
    @else
